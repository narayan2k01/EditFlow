  ...
  return (
    <nav className={`sticky top-0 z-50 border-b ${
      ...
      <div className="container mx-auto px-4">
        {/* We adjust flex direction and padding for different screen sizes */}
          ...
          <div className="flex items-center gap-4 w-full md:w-auto">
            <form onSubmit={handleSearch} className="relative flex-grow">
              <input
                ...
                // The width is now responsive
                className={`w-full md:w-64 pl-4 pr-10 py-2 rounded-lg outline-none transition-colors ${
                  mode === 'dark' 
